...
public class WordCountCombiner extends Configured implements Tool {
  ...
  @Override
	public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "Word Count with ext combiner"); // TODO: define new job instead of null using conf
        ...
        job.setCombinerClass(WCReducerCombiner.class); // as it is the same
