...
public int hashCode() {
  // TODO: implement hash
  return word1.hashCode()*171 + word2.hashCode();
}
...
public boolean equals(Object o) {
  // TODO: implement equals
    if ( o instanceof TextPair ) {
        ...
        return word1.equals(tp.word1) && word2.equals(tp.word2);
    }
    return false;
}
...
public int compareTo(TextPair tp) {
 // TODO: implement the comparison between this and tp
    int y = word1.toString().compareTo(tp.getFirst().toString());
    if (y!=0){
        return y;
    }
 return word2.toString().compareTo(tp.getSecond().toString());
}
