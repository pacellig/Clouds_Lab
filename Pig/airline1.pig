...
B = FOREACH A GENERATE ocode as o;
C = GROUP B BY o;
D = FOREACH C GENERATE $0, COUNT(B);
E = ORDER D by $1 desc;
F = LIMIT E 20;
STORE F INTO './AIRLINE1OUT';
/* airports by input traffic */
filtI = FOREACH A GENERATE dcode as d;
groupI = GROUP filtI by d;
countI = FOREACH groupI GENERATE $0, COUNT(filtI);
orderI = ORDER countI by $1 desc;
limitI = LIMIT orderI 20;
STORE limitI INTO './AIRLINE1IN';
/* total traffic */
joinT = JOIN D by $0, countI by $0; 
countT = FOREACH joinT generate $0, $1+$3;
orderT = ORDER countT by $1 desc;
limitT = LIMIT orderT 20;
STORE limitT INTO './AIRLINE1TOT';
